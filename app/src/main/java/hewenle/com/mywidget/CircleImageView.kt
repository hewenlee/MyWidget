package hewenle.mykotlinlibrary.ui.widget
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        if (rawBitmap != null && mType != TYPE_NONE) {
            ...
            if (mType == TYPE_CIRCLE) {
                ...
                val bitmapRadius:Float = if (mRectRoundRadius - mBorderWidth > 0.0f) (mRectRoundRadius - mBorderWidth ).toFloat()else 0.0f
